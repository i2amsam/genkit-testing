...
class Genkit {
  ...
  prompt(name, options) {
    return __async(this, null, function* () {
      ...
      if (!action) {
        action = (yield prompt(this.registry, name, options)).promptAction;
      }
      const _a = action.__action.metadata.prompt, { template } = _a, opts = __objRest(_a, ["template"]);
      ...
      const p = definePrompt(
        ...
        (input) => __async(this, null, function* () {
          ...
          if (!response.tools && options.tools) {
            response.tools = (yield resolveTools(this.registry, options.tools)).map(toToolDefinition);
          }
  ...
  wrapPromptActionInExecutablePrompt(p, options) {
    ...
    executablePrompt.render = (opt) => __async(this, null, function* () {
      ...
      const promptResult = yield p(__spreadValues({
        ...
        __genkit__sessionState: { state: (_b = getCurrentSession()) == null ? void 0 : _b.state }
      }, opt.input));
      const resultOptions = {
  ...
  configure() {
    ...
    if (this.options.promptDir !== null) {
      const dotprompt = genkitPlugin("dotprompt", (ai) => __async(this, null, function* () {
        var _a2;
        loadPromptFolder(this.registry, (_a2 = this.options.promptDir) != null ? _a2 : "./prompts");
      }));
