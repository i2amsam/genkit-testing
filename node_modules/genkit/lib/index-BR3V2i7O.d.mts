...
declare class Session<S = any> {
    ...
    private sessionData?;
    private store;
    constructor(genkit: Genkit, options?: {
        id?: string;
        stateSchema?: S;
...
export { type BaseGenerateOptions as B, type ChatGenerateOptions as C, type GenkitPlugin as G, MAIN_THREAD as M, type PluginProvider as P, type SessionOptions as S, __disableReflectionApi as _, type GenkitOptions as a, type PromptMetadata as b, Genkit as c, genkit as d, Session as e, type SessionData as f, genkitPlugin as g, getCurrentSession as h, SessionError as i, type SessionStore as j, inMemorySessionStore as k, type PromptRenderOptions as l, type ChatOptions as m, Chat as n, runWithSession as r };
