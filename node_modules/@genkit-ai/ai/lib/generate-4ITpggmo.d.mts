...
import { GenerateRequest, GenerateRequestSchema, ModelArgument, ToolDefinition, Part, MessageData, ModelMiddleware, GenerationCommonConfigSchema } from './model.mjs';
...
type PromptAction<I extends z.ZodTypeAny = z.ZodTypeAny> = Action<I, typeof GenerateRequestSchema> & {
    __action: {
        metadata: {
            type: 'prompt';
        };
...
type PromptGenerateOptions<I = undefined, CustomOptions extends z.ZodTypeAny = z.ZodTypeAny> = Omit<GenerateOptions<z.ZodTypeAny, CustomOptions>, 'prompt' | 'input' | 'model'> & {
...
interface ExecutablePrompt<I = undefined, O extends z.ZodTypeAny = z.ZodTypeAny, CustomOptions extends z.ZodTypeAny = z.ZodTypeAny> {
     ...
     */
    <Out extends O>(input?: I, opts?: PromptGenerateOptions<I, CustomOptions>): Promise<GenerateResponse<z.infer<Out>>>;
    /**
     * Generates a response by rendering the prompt template with given user input and then calling the model.
     * @param input Prompt inputs.
     * @param opt Options for the prompt template, including user input variables and custom model configuration options.
     * @returns the model response as a promise of `GenerateStreamResponse`.
     */
    stream<Out extends O>(input?: I, opts?: PromptGenerateOptions<I, CustomOptions>): Promise<GenerateStreamResponse<z.infer<Out>>>;
    /**
     ...
     */
    generate<Out extends O>(opt: PromptGenerateOptions<I, CustomOptions>): Promise<GenerateResponse<z.infer<Out>>>;
    /**
     ...
     * @returns the model response as a promise of `GenerateStreamResponse`.
     */
    generateStream<Out extends O>(opt: PromptGenerateOptions<I, CustomOptions>): Promise<GenerateStreamResponse<z.infer<Out>>>;
    /**
     ...
     */
    render<Out extends O>(opt: PromptGenerateOptions<I, CustomOptions>): Promise<GenerateOptions<CustomOptions, Out>>;
    /**
...
declare class GenerationResponseError extends GenkitError {
    ...
    constructor(response: GenerateResponse, message: string, status?: GenkitError['status'], detail?: Record<string, any>);
}
...
export { type ExecutablePrompt as E, GenerationBlockedError as G, type PromptAction as P, type ToolAction as T, GenerationResponseError as a, generateStream as b, toGenerateRequest as c, type GenerateOptions as d, type GenerateStreamOptions as e, type GenerateStreamResponse as f, generate as g, definePrompt as h, type PromptConfig as i, type PromptFn as j, type PromptGenerateOptions as k, asTool as l, defineTool as m, type ToolArgument as n, type ToolConfig as o, isPrompt as p, type PromptArgument as q, renderPrompt as r, resolveTools as s, tagAsPreamble as t, lookupToolByName as u, toToolDefinition as v };
