...
import { z } from 'zod';
import { g as StreamingCallback, R as Registry } from './action-5udoTWv8.mjs';
import 'json-schema';
...
streamingCallback?: S extends z.ZodVoid ? undefined : StreamingCallback<z.infer<S>>) => Promise<z.infer<O>> | z.infer<O>;
/**
...
declare class Flow<I extends z.ZodTypeAny = z.ZodTypeAny, O extends z.ZodTypeAny = z.ZodTypeAny, S extends z.ZodTypeAny = z.ZodTypeAny> {
    ...
    invoke(input: unknown, opts: {
        streamingCallback?: S extends z.ZodVoid ? undefined : StreamingCallback<z.infer<S>>;
